      ...
      <div className="relative pt-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            onFocus={onFocus}
            onBlur={onBlur}
            className={`w-full pr-4 py-4 bg-zinc-50 dark:bg-zinc-900/50 border-2 rounded-xl text-zinc-900 dark:text-zinc-100 focus:outline-none focus:bg-white dark:focus:bg-zinc-900 transition-all duration-300 shadow-sm hover:shadow-md focus:placeholder:opacity-0 ${
              error
